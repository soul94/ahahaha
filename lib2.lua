...
function Library:Toggle()
    if game:GetService("CoreGui"):FindFirstChild(LibraryName).Enabled then 
        game:GetService("CoreGui"):FindFirstChild(LibraryName).Enabled = false
    else 
        game:GetService("CoreGui"):FindFirstChild(LibraryName).Enabled = true
    end
end
...
function Library:Create(xHubName,xGameName)
    local xHubName = xHubName or "beg wtf"
    local xGameName = xGameName or "gay wtf"
